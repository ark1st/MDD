...
#%%
######change path
path = 'D:/Depression/MDD_dataset/data/H/EO/*'
...
##############################
    if(len(data_frame.columns) == 20):
        data_frame.to_csv('D:/Depression/preprocessing/EO_ICA/H/'+'O_'+str(k)+'_ica.csv', index=False, header=['Fp1-LE','F3-LE','C3-LE','P3-LE','O1-LE','F7-LE',
                                                                                                    'T3-LE','T5-LE','Fz-LE','Fp2-LE','F4-LE','C4-LE','P4-LE','O2-LE','F8-LE','T4-LE','T6-LE','Cz-LE','Pz-LE','A2-A1'])
    elif(len(data_frame.columns) == 22):
        data_frame.to_csv('D:/Depression/preprocessing/EO_ICA/H/'+'EO_'+str(k)+'_ica.csv', index=False, header=['Fp1-LE','F3-LE','C3-LE','P3-LE','O1-LE','F7-LE',
...
#%%'
    ...
    plt.savefig('D:/Depression/preprocessing/'+str(k)+'.png')
