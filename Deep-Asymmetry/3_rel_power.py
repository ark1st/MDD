...
#theta -> 4,8
######change path
def relative_Power(path, input_list, save_dir):
    total_list = []
    result_list = []
    list_im=input_list
    print(len(list_im))
    ...
    if (count == 20):
        ...
        data_frame.to_csv(save_dir, index=False, header=['Fp1-LE','Fp2-LE','F7-LE','F8-LE','F3-LE','F4-LE','T3-LE','T4-LE','C3-LE','C4-LE','P3-LE','P4-LE','T5-LE','T6-LE','O1-LE','O2-LE'])
    else:
        print("else error")
...
relative_Power(path, list_im,'C:/ARK/eeg')
