...
for k in range(len(list_im)):
    ...
    data_frame = pd.DataFrame(H)

    if(len(data_frame.columns) == 20):
        data_frame.to_csv('./preprocessing/data/H/'+'MDD_EC_'+str(k)+'_pca.csv', index=False, header=['Fp1-LE','F3-LE','C3-LE','P3-LE','O1-LE','F7-LE',
...
'''
    ...
    plt.savefig('./preprocessing/MDD/MDD_EC_'+str(k)+'.png')
'''
