...
# %%
######change path
path = 'D:/Depression/preprocessing/ICA/MDD/*'
...
for k in range(len(list_im)):
    ...
    for i in range(75):
        ...
        if(len(sliced_data.columns) == 20):
            sliced_data.to_csv('D:/Depression/data/sliced/Nor_MDD_ICA/'+str(k)+"_"+str(i)+'.csv', index=False, header=['Fp1-LE','F3-LE','C3-LE','P3-LE','O1-LE','F7-LE',
